...
export function helpModal() {
  const sections = [
    ...
    ["Kötelező kiadások", ["Vedd fel a rendszereseket (törlesztő, TB, hitel), és add meg, kártyával vagy készpénzzel fizeted.", "A „Naptárba” gomb Androidon a Google Naptárt nyitja meg (csak a Mentést kell megnyomni), iPhone-on naptár-fájlt ad, amit az alap Naptár vesz fel.", "A Kiadások tetején mindig látod az esedékeseket, és kipipálhatod, ha fizetted — ilyenkor felajánlja, hogy rögzítse kimenő pénzmozgásként is."]],
    ...
    ["Mentés (fontos!)", ["A biztonsági mentés magától megy: minden blokk-bevitel után letöltődik egy mentés-fájl (iPhone-on rákérdez), és rendszeres telefonos mentés is készül — a gyakorisága (2, 4 vagy 7 nap) a Beállításokban állítható.", "A letöltött mentés-fájlokat időnként tedd felhőbe vagy emailbe — telócsere vagy adatvesztés esetén EBBŐL állítható vissza minden.", "Kézzel bármikor: Beállítások → „Biztonsági mentés fájlba”."]],
